run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|dash-global-eq-displacement\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|dash-global-eq-displacement/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|dash-global-eq-displacement/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|dash-global-eq-displacement/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|dash-global-eq-displacement/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|dash-global-eq-displacement/assets|g' {} \;
